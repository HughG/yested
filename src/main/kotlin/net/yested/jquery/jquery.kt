/**
 * From https://github.com/DefinitelyTyped/DefinitelyTyped/blob/types/jquery/jquery.d.ts rev 6e54cb6, converted with ts2kt 0.0.12
 */
@file:Suppress(
...
external interface JQueryGenericPromise<out T> {
...
external interface JQueryPromiseCallback<in T> {
    @nativeInvoke
